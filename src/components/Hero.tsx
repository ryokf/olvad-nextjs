...
const Hero = () => {
    ...
    return (
        <div className="lg:max-w-7xl w-11/12 mx-auto">
            ...
            <div className="pt-10 lg:pt-0 grid grid-cols-1 grid-rows-2 md:grid-rows-1 md:grid-cols-2 items-stretch max-h-screen">
                <div ref={headTextRef} className="flex flex-col items-start justify-center md:h-screen">
                    ...
                    <TextInput sizing={"lg"} theme={textInputTheme} color='primary' id="email4" type="email" icon={IoSearch} placeholder="Cari menu favoritmu" required className='w-11/12 focus:!outline-primary mx-auto hidden lg:block' />
                </div>
